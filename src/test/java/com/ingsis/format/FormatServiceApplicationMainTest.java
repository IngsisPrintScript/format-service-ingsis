...
class FormatServiceApplicationMainTest {
    ...
    void classIsSpringBootApplicationAnnotated() throws Exception {
        ...
        assertNotNull(cls.getAnnotation(org.springframework.boot.autoconfigure.SpringBootApplication.class));
    }
    ...
    void mainWithMockedSpringApplicationRun() {
        try (MockedStatic<SpringApplication> mocked = Mockito.mockStatic(SpringApplication.class)) {
            mocked.when(
                    () -> SpringApplication.run(Mockito.eq(FormatServiceApplication.class), Mockito.<String[]>any()))
                    .thenReturn(null);
    ...
    void mainInvokesSpringApplicationRun_whenMocked() {
        try (org.mockito.MockedStatic<org.springframework.boot.SpringApplication> mocked = org.mockito.Mockito
            ...
            mocked.when(() -> org.springframework.boot.SpringApplication.run(FormatServiceApplication.class,
                    new String[]{})).thenReturn(
